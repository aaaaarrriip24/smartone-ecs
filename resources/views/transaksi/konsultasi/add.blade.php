    ...
    <form method="post" action="{{ url('konsultasi/store') }}" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" name="kode_konsultasi" class="form-control form-control-sm" placeholder="K-xxxx"
                    required="required">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="date" name="tanggal_konsultasi" class="form-control form-control-sm" placeholder="John Doe"
                    required="required">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="tempat_pertemuan" class="form-control form-control-sm" required="required">
            </div>
            <div class="form-group">
                <label>Topik</label>
                <select name="id_topik" class="form-control form-control-sm select_topik" required="required"></select>
            </div>
            <div class="form-group">
                <label>Isi Topik</label>
                <input type="text" name="isi_konsultasi" class="form-control form-control-sm" placeholder="John Doe"
                    required="required">
            </div>
            <div class="form-group">
                <label>Foto</label>
                <input type="file" name="foto_pertemuan" class="form-control form-control-sm" required="required">
            </div>
            <div class="form-group">
                <label>Petugas</label>
