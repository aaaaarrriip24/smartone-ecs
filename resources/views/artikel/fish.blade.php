...
<div class="container-fluid px-5">
    <div class="row">
        <div class="col-md-8">
            ...
            <h3 class="mb-3 text-center">{{ __("Potensi Ekspor Komoditas Perikanan Indonesia") }}</h3>
            <p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ __("Indonesia merupakan salah satu negara maritim yang kaya akan sumber daya laut, hal tersebut menjadikan Indonesia sebagai salah satu pemasok produk perikanan dunia dan produk perikanan ini sebagai salah satu komoditas unggulan Indonesia yang memiliki potensi besar untuk diekspor. Menurut data dari Kementerian Kelautan dan Perikanan, sektor produksi perikanan Indonesia terbagi menjadi dua, yakni sektor produksi perikanan tangkap (Laut dan Perairan Umum) dan sektor perikanan budidaya.") }}</p>
            
            <p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ __("Total produksi perikanan selama tahun 2021 tercatat sebesar 21,8 juta dan pada tahun 2022 meningkat menjadi sebesar 22,1 juta ton, dan sebesar 24,7 juta ton pada tahun 2023 (KKP, 2024). Pertumbuhan produksi ini menandakan potensi besar pada sektor perikanan sebagai salah satu komoditas strategis untuk ekspor.") }}</p>

            <p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ __("Sektor produksi perikanan tangkap laut pada tahun pada tahun 2021 tercatat sebesar 6,9 juta ton dan meningkat menjadi 7,2 juta ton pada tahun 2022. Komoditas utama yang mendominasi sektor produksi perikanan tangkap laut adalah Udang, Tuna, Cakalang, dan Tongkol. Sementara itu, produksi perikanan tangkap di perairan umum juga menunjukkan peningkatan, dengan total tercatat 462,9 ribu ton pada tahun 2021 dan meningkat menjadi 521,7 ribu ton pada tahun 2022. Adapun komoditas utama yang mendominasi produksi perairan umum adalah jenis Ikan yang sama dan Udang.") }}</p>

            <p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ __("Produksi perikanan budidaya mencatat total produksi sebesar 14,8 juta ton pada tahun 2022 dan meningkat sebesar 16,9 juta ton pada tahun 2023. Adapun komoditas utama pada perikanan budidaya di tahun 2022-2023, antara lain Bandeng, Gurami, Ikan Lainnya, Kakap, Kerapu, Lele, Mas, Nila, Patin, Rumput Laut, dan Udang.") }}</p>

            <p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ __("Provinsi Sulawesi Selatan, Nusa Tenggara Timur, dan Jawa Timur tercatat sebagai tiga provinsi penghasil produk perikanan terbesar pada tahun 2022. Provinsi Sulawesi Selatan memiliki total produksi perikanan sebesar 4,5 juta ton pada tahun 2021 dan pada tahun 2020 menghasilkan jumlah yang sama yaitu 4,5 juta ton. Adapun Provinsi Nusa Tenggara Timur memiliki total produksi perikanan sebesar 1,6 juta ton pada tahun 2022 dan sebesar 1.554.565 ton pada tahun 2023. Sementara itu, Provinsi Jawa Timur memiliki total produksi perikanan sebesar 1.825.182 ton pada tahun 2022 dan sebesar 1,9 juta ton pada tahun 2023. Ketiga provinsi tersebut berkontribusi besar dalam menyuplai kebutuhan perikanan domestik maupun ekspor.") }}</p>

            <p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ __("Meskipun produksi perikanan terus mengalami peningkatan, kinerja ekspor pada produk kelautan dan perikanan pada tahun 2023 justru mengalami sedikit penurunan dibandingkan dengan tahun sebelumnya. Volume ekspor produk perikanan tercatat mencapat 1,2 juta ton pada tahun 2022, sementara pada tahun 2023 tercatat malah mengalami penurunan dari sisi volume sebesar -0,23 persen dibandingan dengan tahun 2022. Penurunan serupa juga tercermin pada nilai ekspor produk perikanan yang tercatat sebesar US$ 5,63 miliar pada tahun 2023, turun sebesar 9,79 persen dibandingkan dengan tahun 2022. Meskipun demikian, jika dilihat dari tren lima tahun terakhir (2019-2023), volume ekspor produk perikanan Indonesia secara rata-rata mengalami pertumbuhan sebesar 0,84 persen, sedangkan nilai ekspornya naik sebesar 3,67 persen.") }}</p>

            <p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ __("Komoditas utama hasil perikanan yang mendominasi ekspor Indonesia selama periode 2019-2023 adalah Udang, Lobster, Tuna, Tongkol, Cakalang, Mutiara, Rumput Laut, dan Rajungan Kepiting. Adapun negara tujuan ekspor terbesar untuk produk perikanan Indonesia pada tahun 2019-2023 diantaranya adalah China, Amerika Serikat, Jepang, Malaysia, Vietnam, dan Thailand. China merupakan negara tujuan utama dengan volume ekspor hasil perikanan terbesar selama tahun 2019- 2023. Kinerja ekspor ke China pada tahun 2023 tercatat sebesar 438,6 ribu ton, sementara pada tahun 2022 sebesar 403,7 ribu ton, artinya mengalami kenaikan sebesar 8,65 persen dibandingkan tahun 2022 (Kementerian Kelautan dan Perikanan, 2024).") }}</p>

            <p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ __("Potensi ekspor produk perikanan Indonesia ini membuka peluang besar bagi pelaku usaha dalam negeri untuk terus meningkatkan kapasitas produksi dan memenuhi permintaan pasar internasional. Seiring dengan pertumbuhan permintaan global untuk produk perikanan yang berkelanjutan dan berkualitas tinggi, pelaku usaha di Indonesia diharapkan mampu memanfaatkan potensi besar ini dengan optimal. Dalam hal ini, dukungan dari Kementerian Perdagangan melalui Export Center Surabaya, akan sangat penting untuk memperkuat daya saing produk perikanan Indonesia di pasar global dan diharapkan ekspor perikanan Indonesia dapat terus berkembang, memberikan kontribusi signifikan bagi pertumbuhan ekonomi nasional.") }}</p>

            <p class="text-muted mb-3">{{ __("Sumber: Kementerian Kelautan dan Perikanan. (2024). ANALISIS INDIKATOR KINERJA UTAMA SEKTOR KELAUTAN DAN PERIKANAN KURUN WAKTU 2019-2023: Vol. Volume 2. Pusat Data, Statistik dan Informasi.")}}</p>
