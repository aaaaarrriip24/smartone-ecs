    ...
    <div class="row">
        <div class="col-md-8">
            <div class="d-flex justify-content-center">
                <img class="img-fluid w-25 mb-4" src="{{ asset('assets/images/ecs/icon_indonesia_great/Food Processing.png') }}" alt="Default Image">
            </div>
            <h3 class="mb-3 text-center">{{ GoogleTranslate::trans("Potensi Ekspor Rempah-Rempah Indonesia", app()->getLocale()) }}</h3>
            <p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ GoogleTranslate::trans("Indonesia merupakan negara kepulauan yang memiliki kekayaan sumber daya alam, dan dikenal sebagai penghasil rempah-rempah sejak zaman dahulu. Badan Kebijakan Perdagangan (BKPerdag) pada tahun 2017,  menyampaikan bahwa Indonesia merupakan salah satu produsen rempah-rempah di dunia yang memiliki peluang besar sebagai pemasok rempah di dunia. Berdasarkan data dari Trade Map (2024), total nilai ekspor untuk komoditas kopi, teh, dan rempah-rempah Indonesia ke dunia mencapai US$ 1,7 milyar pada tahun 2021, dan sebesar US$1,9 milyar 2022, dan pada tahun 2023 tercata sedikit menurun taitu sebesar US$1,6 milyar. Penurunan nilai ekspor yang terjadi pada tahun 2023, meskipun cukup signifikan, masih menempatkan Indonesia sebagai salah satu eksportir utama dunia dalam sektor ini. Fluktuasi tersebut diperkirakan akibat berbagai faktor, mulai dari tantangan global seperti perubahan permintaan pasar, hingga gangguan rantai pasok akibat pandemi. Namun, potensi sektor rempah-rempah Indonesia tetap besar, didukung oleh kualitas produk yang diakui dunia internasional dan komitmen pemerintah serta pelaku usaha untuk memperkuat daya saing produk Indonesia di pasar global.", app()->getLocale()) }}</p>
            <br>
            ...
            <p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ GoogleTranslate::trans("Berdasarkan data yang diperoleh dari Trade Map (2024) pada Gambar 1, komoditas utama rempah Indonesia yang diekspor pada tahun 2019-2024 meliputi Pala, Lada, Kayu Manis, Cengkeh, Jahe, dan Vanila. Komoditas pala, mencatat pertumbuhan yang impresif dari tahun 2019 hingga 2021 dengan nilai ekspor terbesar pada tahun 2021 sebesar US$274,9 juta, namun, terjadi penurunan pada tahun 2023, dimana nilai ekspor turun menjadi $239,2 juta.", app()->getLocale()) }}</p>

            <p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ GoogleTranslate::trans("Komoditas Lada juga merupakan salah satu komoditas unggulan yang mana mencatat nilai ekspor pada tahun 2021 sebesar US$174,9 juta, akan tetapi, setelah tahun 2021 menunjukkan penurunan yang signifikan, yang tercatat hanya sebesar US$117,5 juta di tahun 2023. Adapun komoditas Kayu Manis, yang juga mencatat nilai ekspor tertinggi di tahun 2021 dengan nilai ekspor sebesar US$160, 7 juta, namun, pada tahun berikutnya mengalami penurunan signifikan, yang tercatat hanya sebesar US$99,7 juta di tahun 2023.", app()->getLocale()) }}</p>

            <p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ GoogleTranslate::trans("Selanjutnya, komoditas Cengkeh mencatat nilai ekspor terbesar di tahun 2020 yang mencapai US$176,5 juta dan mengalami penurunan drastis pada tahun 2021 dan 2022. Namun, nilai ekspor Cengkeh mengalami peningkatan kembali pada tahun 2023 sebesar yang mencapai $99,6 juta. Sementara untuk komoditas Vanila justru terus menglami penurunan ekspor dari tahun 2019 hingga 2023, tercatat sebesar US$69,6 juta pada tahun 2019, dan terus mengalami penurunan dan tercatat hanya sebesar US$15,2 juta pada tahun 2023. Di sisi lain komoditas Jahe, justru memiliki tren positif tahun 2019-2023. Jahe, mencatat nilai ekspor sebesar US$18,5 juta pada tahun 2019, namun, pada tahun 2021 dan 2022 mengalami sedikit penurunan dan kembali mengalami peningkatan pada tahun 2023 menjadi sebesar US$41, 9 juta.", app()->getLocale()) }}</p>

            <p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ GoogleTranslate::trans("Secara keseluruhan, nilai ekspor komoditas utama rempah Indonesia yakni Pala, Lada, Kayu Manis, Cengkeh, Jahe dan Vanila menunjukkan fluktuasi selama periode 2019-2024. Perubahan nilai ekspor tersebut kemungkinan besar dipengaruhi oleh beberapa faktor seperti adanya perubahan permintaan global atau perubahan kebutuhan pasar, serta faktor kebijakan perdagangan suatu negara, dan adanya persaingan global. Meskipun demikian, komoditas tersebut tetap menjadi pilar penting dalam kinerja ekspor Indonesia dan memiliki potensi yang besar untuk mendukung pertumbuhan ekonomi di masa depan.", app()->getLocale()) }}</p>

            <p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ GoogleTranslate::trans("Data dari BPS (2024) menunjukkan bahwa sepuluh negara tujuan utama untuk ekspor komoditas Tanaman Obat, Aromatik, dan Rempah-Rempah adalah Thailand, China, Amerika Serikat, India, Vietnam, Belanda, Bangladesh, Jerman, Singapura, dan Pakistan. Nilai ekspor terbesar pada tahun 2023 mencapai US$ 127,1 juta ke China, sebesar US$ 64,4 juta ke India, dan sebesar US$ 46,3 juta ke Amerika Serikat.", app()->getLocale()) }}</p>

            <p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ GoogleTranslate::trans("Sebagai salah satu produsen rempah terbesar di dunia, Indonesia memiliki peluang yang sangat potensial untuk memperluas pasarnya ke seluruh dunia. Kualitas rempah-rempah Indonesia yang telah dikenal sejak zaman dahulu hingga kini terus diminati oleh pasar internasional. Oleh karena itu, upaya untuk meningkatkan ekspor harus menjadi prioritas, mengingat peluang yang besar dalam meningkatkan devisa negara serta kontribusi terhadap pertumbuhan ekonomi nasional.", app()->getLocale()) }}</p>

            <p class="text-justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ GoogleTranslate::trans("Direktorat Jenderal Pengembangan Ekspor Nasional melalui Export Center Surabaya berperan aktif dalam mendukung para pelaku usaha rempah melalui berbagai program pembinaan dan pendampingan dengan tujuan dapat menembus pasar internasional serta memperluas jangkauan pasar. Melalui sinergi dan komitmen bersama, rempah-rempah Indonesia diharapkan mampu bersaing secara lebih efektif di pasar global, menciptakan peluang yang lebih luas dalam memajukan sektor ekspor.", app()->getLocale()) }}</p>
